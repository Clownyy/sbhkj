...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="<?=base_url()?>" class="logo">
      ...
      <span class="logo-mini"><b>S</b>BH</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>SBH</b> Kramat Jati</span>
    </a>
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          ...
          <?php }else if($this->session->userdata('level') == 2){ ?>
            <a href="#"><i class="fa fa-circle text-warning"></i> Dewan</a>
          <?php } ?>
        </div>
      </div>
      <!-- search form -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="<?=base_url('aboutus')?>">
            <i class="fa fa-houzz"></i> <span>About Us</span>
          </a>
        </li>
        <li>
          <a href="<?=base_url('contactus')?>">
            <i class="fa fa-coffee"></i> <span>Contact Us</span>
          </a>
        </li>
      </ul>
  </aside>
